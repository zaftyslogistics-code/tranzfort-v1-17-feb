...
class _SplashScreenState extends ConsumerState<SplashScreen> {
  ...
  Future<void> _checkAuth() async {
    ...
    if (user == null) {
      // First launch: if language not yet chosen, show onboarding (language pick first)
      final prefs = await SharedPreferences.getInstance();
      final hasLanguage = prefs.containsKey('preferred_language');
      if (!mounted) return;
      context.go(hasLanguage ? '/login' : '/onboarding');
      return;
    }
