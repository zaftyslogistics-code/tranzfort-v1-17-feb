...
class _TruckerVerificationScreenState
  ...
  Future<void> _loadExistingData() async {
    ...
    if (userId != null) {
      final trucker =
          await ref.read(databaseServiceProvider).getTruckerData(userId);
      if (trucker != null && mounted) {
        _dlController.text = trucker['dl_number'] as String? ?? '';
      }
    }
  }
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      final String dlFrontPath = '$userId/dl_front.jpg';
      final String dlBackPath = '$userId/dl_back.jpg';
      ...
      // Update trucker data with DL info
      await db.updateTruckerData(userId, {
        'dl_number': _dlController.text.trim().toUpperCase(),
        'dl_front_photo_url': dlFrontPath,
        'dl_back_photo_url': dlBackPath,
      });
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isUploaded ? 'Uploaded ✓' : 'Tap to capture (Required)',
        ...
        child: Form(
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (v) => Validators.required(v, 'Driving licence'),
            ),
            ...
            _buildDocumentUploadCard(
              ...
              photo: _dlFrontPhoto,
              onTap: () async {
                final photo = await _pickDocumentPhoto('DL Front');
                if (photo != null) setState(() => _dlFrontPhoto = photo);
              },
              onClear: () => setState(() => _dlFrontPhoto = null),
            ),
            const SizedBox(height: 12),
            _buildDocumentUploadCard(
              ...
              photo: _dlBackPhoto,
              onTap: () async {
                final photo = await _pickDocumentPhoto('DL Back');
                if (photo != null) setState(() => _dlBackPhoto = photo);
              },
              onClear: () => setState(() => _dlBackPhoto = null),
            ),
            const SizedBox(height: 24),
